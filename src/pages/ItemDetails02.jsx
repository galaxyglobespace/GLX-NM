    ...
    useEffect(() => {
        ...
        if (nftData === null) {
            async function fetchData() {
                ...
                // console.log("id of item", id, mappedData)
                setMappedNftData(mappedData)
                setNftItem(mappedData[parseInt(id)])
                setNftData(data)
            }
            fetchData();
        }
            ...
            </section>
            {
                (nftItem != null) ?
                    <div className="tf-section tf-item-details style-2">
                            ...
                            <div className="row">
                                <div className="col-xl-6 col-md-12">
                                    <div className="content-left">
                                        <div className="media">
                                            {/* {console.log("image", )} */}
                                            <img src={nftItem.img} alt="Galaxy" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-6 col-md-12">
                                            ...
                                            <div className="client-infor sc-card-product">
                                                <div className="meta-info">
                                                    <div className="author">
                                                        ...
                                                        <div className="info">
                                                            <span>Owned By</span>
                                                            <h6> <Link to="/author">{nftItem.nameCollection}</Link> </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="meta-info">
                                                    <div className="author">
                                                        ...
                                                        <div className="info">
                                                            <span>Create By</span>
                                                            <h6> <Link to="/author">{nftItem.nameAuthor}</Link> </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="meta-item-details">
                                                <div className="item-style-2 item-details">
                                                    <ul className="list-details">
                                                        <li><span>Artist : </span><h6>{nftItem.imgAuthor}</h6> </li>
                        ...
                        <LiveAuction data={mappedNFTData} />
                    </div>
                    : ""
            }
            <Footer />
